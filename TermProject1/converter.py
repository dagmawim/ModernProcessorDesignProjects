...
def iType(instruction):
    ...
    if instruction[0] == 'sw' or instruction[0] == 'lw':
        ...
        print "base and imm", baseAndImm[0],"and",baseAndImm[1][:-1]
...
def main():
    inp_file = open('vhdl_input', 'r')
    out_file = open('vhdl_output', 'w')
    line = inp_file.readline()
    print 'Started converting file ...'
    while line:
